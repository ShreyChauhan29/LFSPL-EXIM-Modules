...
page 72095 "LFSPostedPurch. ImpInvoiceSubf"
{
    ApplicationArea = All;
    Caption = 'PostedPurch. ImpInvoiceSubf';
    PageType = ListPart;
    ...
    begin
        ...
        DocumentLineTrackings.SetSourceDoc(NewSourceDocType::"Purchase Invoice", Rec."Document No.", Rec."Line No.", Rec."Blanket Order No.", Rec."Blanket Order Line No.", Rec."Order No.", Rec."Order Line No.");
