...
tableextension 72023 "LFS Sales Invoice Header Ext." extends "Sales Invoice Header"
{
    fields
    {
        ...
        field(72003; "LFS Country Fin Destination"; Code[20])
        {
            DataClassification = CustomerContent;
        ...
        field(72005; "LFS Country Origin of Goods"; Code[20])
        {
            DataClassification = CustomerContent;
            TableRelation = "Country/Region".Code;
        ...
        field(72017; "LFS Comm. Bank Account"; Code[20])
        {
            DataClassification = CustomerContent;
            TableRelation = "Bank Account"."No.";
        ...
        //     DataClassification = CustomerContent;
        // }
        field(72057; "LFS Custom_Serial No."; Code[50])
        {
            DataClassification = CustomerContent;
