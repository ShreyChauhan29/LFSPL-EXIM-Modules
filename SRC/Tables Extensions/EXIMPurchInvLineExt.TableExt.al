...
tableextension 72013 "LFS EXIM Purch. Inv. Line Ext." extends "Purch. Inv. Line"
{
    fields
    {
        ...
        field(72002; "LFS License No."; Code[20])
        {
            ...
            trigger OnValidate()
            var
                RodtepHeader: Record "LFS Rodtep License Header";
            begin
                RodtepHeader.Get("LFS License No.");
                Rec."LFS RoDTEP Value (LCY)" := RodtepHeader."LFS Rodtep Value LCY";
            end;
        }
