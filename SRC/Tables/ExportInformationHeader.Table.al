...
table 72026 "LFS Export Information Header"
{
    Caption = 'Export Information Header';
    ...
    fields
    {
        ...
        field(8; "LFS City"; text[30])
        {
            ...
            begin
                PostCode.SetRange(City, Rec."LFS City");
                if PostCode.FindFirst() then
                    rec."LFS City" := PostCode.City;
            end;
        ...
        field(9; "LFS Pin"; Code[20])
        {
            ...
            var
                PostCode: Record "Post Code";
            begin
                if PostCode.Get(Rec."LFS Pin") then
                    Rec."LFS City" := PostCode.City;
            end;
        }
        ...
        {
            DataClassification = CustomerContent;
            Caption = 'LC Issued Date';
        }
        // field(40; "Port of Loading"; Text[50])
        // {
        //     DataClassification = CustomerContent;
        //     TableRelation = "LFS EXIM Port";
        //     Caption = 'Port of Loading';
        // }
        // field(41; "Port of Discharge"; Text[50])
        // {
        //     DataClassification = CustomerContent;
        //     TableRelation = "LFS EXIM Port";
        ...
        // }
        // field(84; "LFS Sp Notes"; Text[100])
        // {
        //     DataClassification = CustomerContent;
