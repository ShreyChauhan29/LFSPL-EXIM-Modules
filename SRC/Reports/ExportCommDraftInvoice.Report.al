...
report 72005 "LFS Export Comm. Draft Invoice"
{
    ApplicationArea = All;
    Caption = 'Export Commercial Draft Invoice';
    UsageCategory = ReportsAndAnalysis;
    DefaultLayout = RDLC;
    RDLCLayout = './src/Reports Layouts/Export Commercial Draft Invoice Report.rdl';
    dataset
    {
        dataitem(SalesHeader; "Sales Header")
        {
            ...
            dataitem("Sales Line"; "Sales Line")
            {
                ...
                DataItemTableView = sorting("Line No.") where("Qty. to Ship" = filter(<> 0));//Type = filter(Type::Item | Type::"Charge (Item)"),
                ...
                column(TotalAmount; TotalAmounts)
                {
                }
                ...
                //     trigger OnAfterGetRecord()//Packing List
                //     begin
                //         // ILE.Reset();
                ...
                begin
                    ...
                    // CheckReport.FormatNoText(Notext2, TotalAmounts - TotalLineDiscountAmount, SalesHeader."Currency Code");
    ...
    var
        ...
        BankAccNo: Text;
        BankAddress: Text;
        BillToCountry, LocState, ShipToCountry : Text;
        ...
        IntermediateBank, paymenttermname : Text;
        LCNo: Text;
        Name: Text;
        PaymentTerms2: Text;
