report 72016 "LFS Custom Packing List New"
{
    ApplicationArea = All;
        ...
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            dataitem("Sales Invoice Line"; "Sales Invoice Line")
            {
                ...
                dataitem("LFS Packing List"; "LFS EXIM Posted Packing Table")
                {
                    ...
                    column(LFS_EX_Custom_Serial_No_; '"LFS Custom Serial No."')
                    {
                    }
    ...
    var
        ...
        ComInfoState, BankAccNo : Text[50];
        CompInShiptoState: Text[50];
        CompInShiptoCoutry: Text[50];
        CountryName_Comp, ShiptoCoutry, BilltoCountry : Text[50];
        PackingNo: Integer;
