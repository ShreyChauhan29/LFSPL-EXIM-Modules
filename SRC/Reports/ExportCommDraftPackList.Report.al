...
report 72004 "LFSExport Comm Draft Pack List"
{
    ApplicationArea = All;
    Caption = 'Export Commercial Draft Pack List';
    ...
    var
        ...
        Address: Text;
        Address1: Text;
        BankAccNo, paymenttermname, TermsDescription : Text;
        BankAddress: Text;
        ...
        Bill_to_County, BilltoCountry, ShiptoCoutry : Text[50];
        ...
        CartonDimensions, Consignee_Address : Text[500];
