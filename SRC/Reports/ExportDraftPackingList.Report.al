report 72018 "LFS Export Draft Packing List"
{
    ApplicationArea = All;
    Caption = 'Commercial Dispatch Packing List';
        ...
        dataitem(SalesHeader; "Sales Header")
        {
            ...
            begin
                ...
                if ExportInformation.FindFirst() then begin
                    ...
                    Delivery_Terms := ExportInformation."LFS Terms of Delivery";
                    ...
                    BuyerIfotherthenConsignee_ := ExportInformation."LFS Consignee Name & Address";
    ...
    var
        ...
        License_No_: Code[20];
        No_LIC: Code[20];
        Issue_Date, CustomerOrderDate : Date;
