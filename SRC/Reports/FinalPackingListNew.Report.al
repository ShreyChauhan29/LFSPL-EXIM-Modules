report 72019 "Final Packing List New"
{
    ApplicationArea = All;
    Caption = 'Final Packing List';
    UsageCategory = ReportsAndAnalysis;
    DefaultLayout = RDLC;
    RDLCLayout = './SRC/Reports Layouts/Final Packing List New.rdl';
    dataset
    {//Created New Report 31/07/2024
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            dataitem("Sales Invoice Line"; "Sales Invoice Line")
            {
                ...
                //     DataItemLink = "LFS Posted Export Shipment" = field("Shipment No."), "LFS_EX_PostExShipmentLineNo." = field("Shipment Line No.");
                ...
                begin
                    ...
                    // IncoTermsDescription := ExpInfo."LFS_EX_Sp Notes";
                    // CustomerOrderNo := ExpInfo."LFS Customer Order No.";
                    // CustomerOrderDate := ExpInfo."LFS Customer Order Date 2";
                    //     ShippingMrks := ExpInfo."LFS_EX_Shipping Marks";
                    //     ContainerDetails := ExpInfo."LFS_EX_Description of Goods";
                    // end;
            ...
            begin
                ...
                if PostedExportInformation.FindFirst() then begin
                    ShipBillNo := "Sales Invoice Header"."LFS Shipping Bill No.";
                    ShipBillDate := "Sales Invoice Header"."LFS Shipping Bill Date";
                    ...
                    PaymentTerms := "Sales Invoice Header"."Payment Terms Code";
                    Delivery_Terms := PostedExportInformation."LFS Terms of Delivery";
                    // PaymentTerms2 := PostedExportInformation."LFS Payment Terms 2";
                    PortName := "Sales Invoice Header"."LFS Port of Discharge";
                    PortOfLoading := "Sales Invoice Header"."LFS Port of Loading";
    ...
    var
        ...
        CompInShiptoState, ShiptoCoutry, BilltoCountry : Text[50];
        ...
        Seller_Address, CartonDimensions : Text[500];
