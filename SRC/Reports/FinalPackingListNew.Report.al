...
report 72006 "LFS Final Packing List New"
{
    ApplicationArea = All;
        ...
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            dataitem("Sales Invoice Line"; "Sales Invoice Line")
            {
                ...
                begin
                    ...
                    // ExpInfo.Reset();
                    // ExpInfo.SetRange("LFS_EX_Document No.", "Sales Invoice Line"."Document No.");
    ...
    var
        ...
        BilltoCountry, CompInShiptoState, ShiptoCoutry : Text[50];
