...
report 72009 "LFS Export Custom Invoice"
{
    ApplicationArea = All;
    Caption = 'Export Custom Invoice';
    UsageCategory = ReportsAndAnalysis;
    DefaultLayout = RDLC;
    RDLCLayout = './src/Reports Layouts/Custom Invoice New.rdl';
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            dataitem("Sales Invoice Line"; "Sales Invoice Line")
            {
                ...
                DataItemTableView = sorting("Document No.", "Line No.") where(Type = filter(Type::Item | Type::"Charge (Item)"));
                column(Type; Type)
                {
                }
                ...
                {
                    DataItemLinkReference = "Sales Invoice Line";
                    DataItemLink = "Document No." = field("Document No."), "Document Line No." = field("Line No."), "Item No." = field("No."), "Variant Code" = field("Variant Code"), "Location Code" = field("Location Code");
                ...
                begin
                    ...
                    Clear(Entrynos);
                    Clear(HSNSACDesc);
                    HSNSAC.SetRange(Code, "Sales Invoice Line"."HSN/SAC Code");
                    if HSNSAC.FindFirst() then
                        HSNSACDesc := HSNSAC.Description;
                    ...
                    // ReservationEntry.SetRange("Source ID", "Sales Invoice Line"."Document No.");
                    // ReservationEntry.SetRange("Source Ref. No.", "Sales Invoice Line"."Line No.");
                    // ReservationEntry.SetRange("Item No.", "Sales Invoice Line"."No.");
                    ...
                    if SalesInvLine.FindSet() then
                        repeat
                            TotalAmounts += SalesInvLine.Quantity * SalesInvLine."Unit Price";
                            TotalLineDiscountAmount += SalesInvLine."Line Discount Amount";
                        until SalesInvLine.Next() = 0;
                    TotalAmount += "Sales Invoice Line".Quantity * "Sales Invoice Line"."Unit Price";
                    // eximmgmt.LFS_EX_InitTextVariable();
                    // eximmgmt.LFS_EX_FormatNoText(Notext2, TotalAmounts - TotalLineDiscountAmount, "Sales Invoice Header"."Currency Code");
                    AmountInWords.InitTextVariable();
                    AmountInWords.FormatNoText(Notext2, TotalAmounts - TotalLineDiscountAmount, "Sales Invoice Header"."Currency Code");
            ...
            dataitem("Sales Comment Line"; "Sales Comment Line")
            {
                ...
                DataItemTableView = where("Document Line No." = const(0), "Document Type" = filter("Sales Comment Document Type"::"Posted Invoice"));
            ...
            begin
                ...
                ExpInfo.Reset();
                ExpInfo.SetRange("LFS Document No.", "Sales Invoice Header"."No.");
    ...
    var
        ...
        CGSTPer: Decimal;
        GrossWeight: Decimal;
        GrossWeightPack, TotalAmounts, TotalLineDiscountAmount : Decimal;
        IGSTAmt: Decimal;
        IGSTPer: Decimal;
        NetWeight: Decimal;
        ...
        Address: Text;
        Address1: Text;
        BankAccNo, CountryFinalDestinationName, HSNSACDesc : Text;
        BankAddress, IntermediateBank : Text;
        BillToCountry, ShipToCountry, TermsDescription : Text;
        ...
        IncoTermsDescription, LocState : Text;
        LCNo: Text;
        Name: Text;
        PaymentTerms2: Text;
