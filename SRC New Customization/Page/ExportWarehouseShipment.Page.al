...
page 72119 "LFS Export WarehouseShipment"
{
    ApplicationArea = All;
    ...
    layout
    {
        area(content)
        {
            ...
            part(WhseShptLines; "LFS Export Whse. Shipment Subf")
            {
                ApplicationArea = Warehouse;
    ...
    actions
    {
        ...
        area(processing)
        {
            ...
            group(EXIMs)
            {
                ...
                action("LFS Export Packing List")
                {
                    ...
                    RunPageLink = "LFS Source Document No." = field("No."), "LFS Source Document Type" = filter("Warehouse Shipment");
                }
            }
        }
        area(Promoted)
        {
            ...
            {
                Caption = 'EXIM';
                actionref(Export_Information_promoted; "Export Information")
                { }
