...
page 72108 "LFS Export Sales Invoice List"
{
    // ApplicationArea = All;
    ...
    UsageCategory = Lists;
    CardPageID = "LFS Export Sales InvoiceNew";
    DataCaptionFields = "Sell-to Customer No.";
    Editable = false;
    QueryCategory = 'Sales Invoice List';
    RefreshOnActivate = true;
    SourceTableView = where("Document Type" = const(Invoice), "LFS EXIM Type" = filter(Export));
