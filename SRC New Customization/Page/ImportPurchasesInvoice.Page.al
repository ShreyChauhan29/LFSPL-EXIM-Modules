...
page 72115 "LFS Import Purchases Invoice"
{
    ApplicationArea = All;
    ...
    SourceTableView = where("Document Type" = filter(Invoice), "LFS EXIM Type" = filter(Import));
    ...
    layout
    {
        area(content)
        {
            ...
            part(PurchLines; "LFS Import Purch. Invoice Subf")
            {
                ApplicationArea = Basic, Suite;
