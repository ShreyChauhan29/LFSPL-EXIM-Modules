...
page 72042 "Blanket Import Purch Order Sub"
{
    ApplicationArea = All;
    AutoSplitKey = true;
    Caption = 'Lines';
    ...
    SourceTableView = where("Document Type" = filter("Blanket Order"), "LFS EXIM Type" = filter(Import));
    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                {
                    ApplicationArea = Dimensions;
                    ToolTip = 'Specifies the code for Shortcut Dimension 3, which is one of the eight shortcut dimensions that you can set up in the General Ledger Setup window.';
                    CaptionClass = '1,2,3';
                ...
                {
                    ApplicationArea = Dimensions;
                    ToolTip = 'Specifies the code for Shortcut Dimension 4, which is one of the eight shortcut dimensions that you can set up in the General Ledger Setup window.';
                    CaptionClass = '1,2,4';
                ...
                {
                    ApplicationArea = Dimensions;
                    ToolTip = 'Specifies the code for Shortcut Dimension 5, which is one of the eight shortcut dimensions that you can set up in the General Ledger Setup window.';
                    CaptionClass = '1,2,5';
                ...
                {
                    ApplicationArea = Dimensions;
                    ToolTip = 'Specifies the code for Shortcut Dimension 6, which is one of the eight shortcut dimensions that you can set up in the General Ledger Setup window.';
                    CaptionClass = '1,2,6';
                ...
                {
                    ApplicationArea = Dimensions;
                    ToolTip = 'Specifies the code for Shortcut Dimension 7, which is one of the eight shortcut dimensions that you can set up in the General Ledger Setup window.';
                    CaptionClass = '1,2,7';
                ...
                {
                    ApplicationArea = Dimensions;
                    ToolTip = 'Specifies the code for Shortcut Dimension 8, which is one of the eight shortcut dimensions that you can set up in the General Ledger Setup window.';
                    CaptionClass = '1,2,8';
