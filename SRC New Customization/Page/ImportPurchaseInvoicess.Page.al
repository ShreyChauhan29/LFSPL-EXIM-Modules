...
page 72114 "LFS Import Purchase Invoicess"
{
    // ApplicationArea = All;
    ...
    CardPageID = "LFS Import Purchases Invoice";
    DataCaptionFields = "Buy-from Vendor No.";
    Editable = false;
    QueryCategory = 'Purchase Invoices';
    RefreshOnActivate = true;
    SourceTableView = where("Document Type" = const(Invoice), "LFS EXIM Type" = filter(Import));
