...
page 72111 "LFS Import Purchase Orderss"
{
    // ApplicationArea = All;
    ...
    UsageCategory = Lists;
    CardPageID = "LFS Import Purchases Order";
    DataCaptionFields = "Buy-from Vendor No.";
    Editable = false;
    QueryCategory = 'Purchase Order List';
    RefreshOnActivate = true;
    SourceTableView = where("Document Type" = const(Order), "LFS EXIM Type" = filter(Import));
