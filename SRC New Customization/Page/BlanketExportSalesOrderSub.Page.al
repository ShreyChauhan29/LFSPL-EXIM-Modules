...
page 72009 "Blanket Export Sales Order Sub"
{
    ApplicationArea = All;
    // Caption = 'Blanket Export Sales Order Sub';
    AutoSplitKey = true;
    Caption = 'Lines';
    DelayedInsert = true;
    LinksAllowed = false;
    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                {
                    ApplicationArea = Dimensions;
                    ToolTip = 'Specifies the code for Shortcut Dimension 3, which is one of the shortcut dimensions that you set up in the General Ledger Setup window.';
                    CaptionClass = '1,2,3';
                ...
                {
                    ApplicationArea = Dimensions;
                    ToolTip = 'Specifies the code for Shortcut Dimension 4, which is one of the shortcut dimensions that you set up in the General Ledger Setup window.';
                    CaptionClass = '1,2,4';
                ...
                {
                    ApplicationArea = Dimensions;
                    ToolTip = 'Specifies the code for Shortcut Dimension 5, which is one of the shortcut dimensions that you set up in the General Ledger Setup window.';
                    CaptionClass = '1,2,5';
                ...
                {
                    ApplicationArea = Dimensions;
                    ToolTip = 'Specifies the code for Shortcut Dimension 6, which is one of the shortcut dimensions that you set up in the General Ledger Setup window.';
                    CaptionClass = '1,2,6';
                ...
                {
                    ApplicationArea = Dimensions;
                    ToolTip = 'Specifies the code for Shortcut Dimension 7, which is one of the shortcut dimensions that you set up in the General Ledger Setup window.';
                    CaptionClass = '1,2,7';
                ...
                {
                    ApplicationArea = Dimensions;
                    ToolTip = 'Specifies the code for Shortcut Dimension 8, which is one of the shortcut dimensions that you set up in the General Ledger Setup window.';
                    CaptionClass = '1,2,8';
