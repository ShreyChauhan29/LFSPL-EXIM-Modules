...
page 72112 "LFS Import Purchases Order"
{
    ApplicationArea = All;
    ...
    SourceTableView = where("Document Type" = filter(Order), "LFS EXIM Type" = filter(Import));
    ...
    layout
    {
        area(content)
        {
            ...
            part(PurchLines; "LFS Import Purchase Order Subf")
            {
                ApplicationArea = Suite;
