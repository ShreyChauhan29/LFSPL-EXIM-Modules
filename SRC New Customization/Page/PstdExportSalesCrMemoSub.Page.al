...
page 72031 "Pstd Export Sales Cr. Memo Sub"
{
    ApplicationArea = All;
    PageType = ListPart;
    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                {
                    ApplicationArea = Dimensions;
                    ToolTip = 'Specifies the code for Shortcut Dimension 7, which is one of six shortcut dimension codes that you set up in the General Ledger Setup window.';
                    CaptionClass = '1,2,7';
                ...
                {
                    ApplicationArea = Dimensions;
                    ToolTip = 'Specifies the code for Shortcut Dimension 8, which is one of six shortcut dimension codes that you set up in the General Ledger Setup window.';
                    CaptionClass = '1,2,8';
