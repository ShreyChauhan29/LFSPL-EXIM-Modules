...
page 72104 "Pstd ImportPurch. Cr. Memo Sub"
{
    ApplicationArea = All;
    PageType = ListPart;
    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                {
                    ApplicationArea = Dimensions;
                    ToolTip = 'Specifies the code for Shortcut Dimension 3, which is one of the eight shortcut dimension codes that you can set up in the General Ledger Setup window.';
                    CaptionClass = '1,2,3';
                ...
                {
                    ApplicationArea = Dimensions;
                    ToolTip = 'Specifies the code for Shortcut Dimension 4, which is one of the eight shortcut dimension codes that you can set up in the General Ledger Setup window.';
                    CaptionClass = '1,2,4';
                ...
                {
                    ApplicationArea = Dimensions;
                    ToolTip = 'Specifies the code for Shortcut Dimension 5, which is one of the eight shortcut dimension codes that you can set up in the General Ledger Setup window.';
                    CaptionClass = '1,2,5';
                ...
                {
                    ApplicationArea = Dimensions;
                    ToolTip = 'Specifies the code for Shortcut Dimension 6, which is one of the eight shortcut dimension codes that you can set up in the General Ledger Setup window.';
                    CaptionClass = '1,2,6';
                ...
                {
                    ApplicationArea = Dimensions;
                    ToolTip = 'Specifies the code for Shortcut Dimension 7, which is one of the eight shortcut dimension codes that you can set up in the General Ledger Setup window.';
                    CaptionClass = '1,2,7';
                ...
                {
                    ApplicationArea = Dimensions;
                    ToolTip = 'Specifies the code for Shortcut Dimension 8, which is one of the eight shortcut dimension codes that you can set up in the General Ledger Setup window.';
                    CaptionClass = '1,2,8';
