...
page 72014 "LFS Export Sales Quote"
{
    ApplicationArea = All;
    Caption = 'Export Sales Quote';
    PageType = Card;
    SourceTable = "Sales Header";
    RefreshOnActivate = true;
    SourceTableView = where("Document Type" = filter(Quote), "LFS EXIM Type" = filter(Export));
    UsageCategory = None;
    ...
    layout
    {
        area(content)
        {
            ...
            part(SalesLines; "LFS Export Sales Quote Subform")
            {
                ApplicationArea = Basic, Suite;
