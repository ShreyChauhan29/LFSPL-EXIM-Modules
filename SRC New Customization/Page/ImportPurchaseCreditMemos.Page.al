...
page 72099 "Import Purchase Credit Memos"
{
    ...
    UsageCategory = Lists;
    CardPageID = "LFS Import Purchase CreditMemo";
    DataCaptionFields = "Buy-from Vendor No.";
    Editable = false;
    QueryCategory = 'Purchase Credit Memos';
    RefreshOnActivate = true;
    SourceTableView = where("Document Type" = const("Credit Memo"), "LFS EXIM Type" = const(Import));
    ...
    var
        LinesInstructionMgts: Codeunit "Lines Instruction Mgt.";
    begin
        LinesInstructionMgts.PurchaseCheckAllLinesHaveQuantityAssigned(PurchaseHeader);
    end;
