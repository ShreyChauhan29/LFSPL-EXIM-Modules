...
page 72044 "LFS Import Purchase Quote"
{
    ApplicationArea = All;
    Caption = 'Import Purchase Quote';
    PageType = Document;
    SourceTable = "Purchase Header";
    RefreshOnActivate = true;
    SourceTableView = where("Document Type" = filter(Quote), "LFS EXIM Type" = const(Import));
    UsageCategory = None;
    ...
    layout
    {
        area(content)
        {
            ...
            part(PurchLines; "LFS Import Purchase Quote Subf")
            {
                ApplicationArea = Suite;
